  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context
          ...
          .add(CheckMovieOnWatchlist(movieId: widget.id));
      context
          .read<MovieRecommendationBloc>()
          .add(FetchMovieRecommendation(movieId: widget.id));
    });
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocListener<MovieWatchlistBloc,
                              ...
                              child: BlocBuilder<MovieWatchlistStatusBloc,
                                  MovieWatchlistStatusState>(
                                builder: (context, state) {
                                  if (state is MovieWatchlistStatusLoaded) {
                                    final isMovieExistAtWatchlist =
                                        state.isExistAtWatchlist;
                                    return ElevatedButton(
                                      onPressed: () {
                                        if (!isMovieExistAtWatchlist) {
                                          context
                                              .read<MovieWatchlistBloc>()
                                              .add(SaveMovieToWatchlist(
                                                  movieDetail: movieDetail));
                                          context
                                              .read<MovieWatchlistStatusBloc>()
                                              .add(CheckMovieOnWatchlist(
                                                  movieId: movieDetail.id));
                                        } else {
                                          context
                                              .read<MovieWatchlistBloc>()
                                              .add(RemoveMovieToWatchlist(
                                                  movieDetail: movieDetail));
                                          context
                                              .read<MovieWatchlistStatusBloc>()
                                              .add(CheckMovieOnWatchlist(
