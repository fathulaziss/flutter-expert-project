  ...
  group('Movie Search BLoC', () {
    test('Initial state should be empty', () {
      expect(
        ...
        const MovieSearchInitial(state: RequestState.Empty),
      );
    });
    ...
    blocTest<MovieSearchBloc, MovieSearchState>(
      ...
      expect: () {
        return [
          const MovieSearchLoading(state: RequestState.Loading),
          MovieSearchLoaded(movies: tMovieList, state: RequestState.Loaded),
        ];
      },
      verify: (bloc) {
